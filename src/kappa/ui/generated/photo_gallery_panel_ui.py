...
class Ui_PhotoGalleryPanel(object):
    def setupUi(self, PhotoGalleryPanel):
        ...
        self.searchActionButton = QtWidgets.QPushButton(self.header)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../../../../../../.designer/icons/cache/search.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.searchActionButton.setIcon(icon)
        self.searchActionButton.setObjectName("searchActionButton")
        self.headerLayout.addWidget(self.searchActionButton)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../../../../../../.designer/icons/cache/advanced_search.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.advancedSearchActionButton.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../../../../../../../.designer/icons/cache/import_folder.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.importFolderActionButton.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../../../../../../../.designer/icons/cache/change_theme.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.changeThemeActionButton.setIcon(icon3)
        ...
        self.content.setGeometry(QtCore.QRect(0, 0, 1077, 735))
